...
if __name__ == "__main__":
    ...
    job_dir = os.path.join(PATHS.jobs, "check_ehe_mc_ids")
    ...
    fpath = os.path.join("/data", "ana", "PointSource", "PS", "version-004-p00",
                         "nugen")
    gcd_path = os.path.join("/data", "sim", "sim-new", "downloads", "GCD")
    
    files = {
        "20878": {
            "path": os.path.join(fpath, "20878", "i3"),
            "gcd": os.path.join(gcd_path, "GeoCalibDetectorStatus_2012.56063_V1.i3.gz"),
            "legacy": True,
            },
        "21002": {
            "path": os.path.join(fpath, "21002", "i3"),
            "gcd": os.path.join(gcd_path, "GeoCalibDetectorStatus_2012.56063_V1.i3.gz"),
            "legacy": True,
            },
        "21220": {
            "path": os.path.join(fpath, "21220", "i3"),
            "gcd": os.path.join(gcd_path, "GeoCalibDetectorStatus_2012.56063_V1.i3.gz"),
            "legacy": True,
            }
        }
    ...
    outpath_1 = os.path.join(PATHS.data, "check_ehe_alert_mc_ids")
    #outpath_2 = os.path.join(PATHS.data, "check_my_ehe_mc_ids")
    outpath_3 = os.path.join(PATHS.data, "check_ehe_alert_hb_mc_ids")
    outpath_4 = os.path.join(PATHS.data, "check_hese_mc_ids")
