...
_repo_path = _os.path.join("/home", "jkollek", "punktquellensuche",
                           "csky_ehe_stacking")
...
_paths = {
    "repo": _repo_path,
    "local": _os.path.join(_repo_path, "out_test"),
    "data": _os.path.join("/data", "user", "jkollek", _repo_name,
                          "rawout_tests"),
    "jobs": _os.path.join(_repo_path, "jobfiles"),
    "plots": _os.path.join(_repo_path, "plots"),
}
