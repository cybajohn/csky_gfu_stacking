...
inpath = os.path.join(PATHS.data, "check_ehe_mc_ids")
outpath = os.path.join(PATHS.local, "check_ehe_mc_ids")

path_names = ["check_ehe_alert_mc_ids", "check_ehe_alert_hb_mc_ids", "check_hese_mc_ids"]
